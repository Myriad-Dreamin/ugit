...
- [x] 1.1 Review the approved OpenSpec artifacts for "Implement ugit PR runner end-to-end" and confirm the canonical request/PR title is `feat(pr/runner): Implement ugit PR runner end-to-end`
- [x] 1.2 Confirm the proposal is ready for pooled execution, the reusable worktree from `/home/kamiyoru/work/ts/ugit/.meow-team-worktrees/meow-N` can be claimed, and conventional-title metadata `feat(pr/runner)` stays separate from `branchPrefix` and change paths
...
- [x] 2.2 Run validation and capture reviewer findings for "Implement ugit PR runner end-to-end"
