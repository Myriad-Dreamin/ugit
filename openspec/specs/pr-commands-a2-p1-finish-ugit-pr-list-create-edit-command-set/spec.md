# pr-commands-a2-p1-finish-ugit-pr-list-create-edit-command-set Specification

## Purpose
Define the repository-scoped `ugit pr list`, `ugit pr create`, and
`ugit pr edit` behavior, including the shared pull-request contracts and the
create-vs-edit-vs-sync boundaries exposed through the CLI and server APIs.
