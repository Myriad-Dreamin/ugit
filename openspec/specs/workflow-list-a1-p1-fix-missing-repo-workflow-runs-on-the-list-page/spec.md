# workflow-list-a1-p1-fix-missing-repo-workflow-runs-on-the-list-page Specification

## Purpose
Define repository-scoped workflow list visibility for queued and recorded
workflow runs so repository workflow pages keep showing the owning repo's runs
after queueing, bootstrap, and refresh even when execution paths differ from
